        ...
        <form action="" enctype="multipart/form-data" method="POST" name="form1">
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="tel" id="num_nomer_hp" name="num_nomer_hp" class="form-control" required placeholder="Format : 08123456789">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="tb_alamat_user" name="tb_alamat_user" class="form-control">
                </div>
