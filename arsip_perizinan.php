...
<html lang="en">
<head>
    <title>Arsip Perizinan - GoKarang</title>
        <meta charset="utf-8">
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                ...
                <div class="row">
                        <div class="col">
                            <h4><span class="align-middle font-weight-bold">Arsip Perizinan</span></h4>
                            <small class="text-muted"><i class="nav-icon text-info fas fa-info-circle"></i> Informasi mengenai penggunaan titik terumbu karang oleh perusahaan serta dokumen perizinan oleh Dinas Kelautan dan Perikanan setempat</small>
                        </div>
