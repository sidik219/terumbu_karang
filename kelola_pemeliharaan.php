...
if (isset($_GET['id_status_pemeliharaan'])) {
  ...
  if ($id_status_pemeliharaan == 1) { //lihat pending
    $sqlviewpemeliharaan = 'SELECT * FROM t_pemeliharaan
                          ...
                          ORDER BY t_pemeliharaan.id_pemeliharaan DESC';
  } elseif ($id_status_pemeliharaan == 2) { //lihat selesai
    $sqlviewpemeliharaan = 'SELECT * FROM t_pemeliharaan
                          LEFT JOIN t_lokasi ON t_pemeliharaan.id_lokasi = t_lokasi.id_lokasi
                          LEFT JOIN t_status_pemeliharaan ON t_pemeliharaan.id_status_pemeliharaan = t_status_pemeliharaan.id_status_pemeliharaan
              ...
              ?>
                ...
                <tr>
                  <td colspan="5">
                    <!--collapse start -->
                    <div class="row  m-0">
                      <div class="col-12 cell detailcollapser<?= $pemeliharaan->id_pemeliharaan ?>" data-toggle="collapse" data-target=".cell<?= $pemeliharaan->id_pemeliharaan ?>, .contentall<?= $pemeliharaan->id_pemeliharaan ?>">
                        <p class="fielddetail<?= $pemeliharaan->id_pemeliharaan ?>  btn btn-act">
