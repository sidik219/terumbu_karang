                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col">
                            ...
                            <p>Berikan Berita Kegiatan Seputar Tangkolak</p>
                            <p class="small">
                                <b>Berita Kegiatan Berada Di Beranda Tangkolak</b>
                                <span class="mytooltip tooltip-effect-1">
                                    <span class="fas fa-info-circle"></span>
                                    <span class="tooltip-content clearfix">
                                        <img src="./images/tooltips/berita_kegiatan.png">
                                ...
                                <?php foreach ($rowKegiatan as $kegiatan) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a onclick="return konfirmasiHapusKegiatan(event)" href="hapus.php?type=berita_kegiatan&id_kegiatan=<?= $kegiatan->id_kegiatan ?>" class="far fa-trash-alt btn btn-act"></a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="4">
                                            ...
                                            <div class="row  m-0">
                                                <table>
                                                    <div class="col-12 cell detailcollapser<?= $kegiatan->id_kegiatan ?>" data-toggle="collapse" data-target=".cell<?= $kegiatan->id_kegiatan ?>, .contentall<?= $kegiatan->id_kegiatan ?>">
                                                    ...
                                                    <div class="col-12 cell<?= $kegiatan->id_kegiatan ?> collapse contentall<?= $kegiatan->id_kegiatan ?> border rounded shadow-sm p-3">
                                                        ...
                                                        <div class="row  mb-3">
                                                            ...
                                                            <div class="col isi">
                                                                <img src="<?= $kegiatan->foto_kegiatan ?>?<?php if ($status = 'nochange') {
                                                                                                                echo time();
                                                                                                            } ?>" width="100px">
                                                            </div>
                                                        </div>
