    ...
    <div class="informational">
        <div class="informational-container">
            ...
            <div class="tkjb-banner-caption">
                <h2 style="text-align:center;">Wisata Bahari Tangkolak</h2>
                <p>
                Perairan tangkolak dikenal sebagai kuburan bagi kapal-kapal Kongsi Dagang atau perusahaan Hindia Timur Belanda (VOC) yang tenggelam ratusan tahun lalu.
                            ...
                            <div class="col-sm-12  col-lg-4 p-5 text-center tabel-kondisi-tangkolak ">
                                <div class="row justify-content-center">
                                    <div class="card card-pilihan mb-4 shadow-sm">
                                        <a href="">
                                            <img class="card-img-top" width="100%" src="img/bmkt-tangkolak.jpg">
                                        </a>
                                            <div class="card-body">
                                                <p > <h5 class="max-length">Diving BMKT</h5></p>
                                                <p class="max-length1">Selami kapal karam peninggalan Belanda</p>
