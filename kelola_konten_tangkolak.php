                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col">
                            ...
                            <p>
                                Beri Foto Foto Menarik Untuk Para Pengunjung Website
                            </p>
                            <p class="small">
                                <b>Halaman Ini Berada Di Website Tangkolak</b>
                                <span class="mytooltip tooltip-effect-1">
                                    <span class="fas fa-info-circle"></span>
                                    <span class="tooltip-content clearfix">
                                        <img src="./images/tooltips/banner.png">
                                ...
                                <?php foreach ($rowKonten as $lokasi) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a onclick="return konfirmasiHapusKonten(event)" href="hapus.php?type=konten_lokasi&id_konten_lokasi=<?= $lokasi->id_konten_lokasi ?>" class="far fa-trash-alt btn btn-act"></a>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td colspan="5">
                                            ...
                                            <div class="row  m-0">
                                                <table>
                                                    <div class="col-12 cell detailcollapser<?= $lokasi->id_konten_lokasi ?>" data-toggle="collapse" data-target=".cell<?= $lokasi->id_konten_lokasi ?>, .contentall<?= $lokasi->id_konten_lokasi ?>">
                                                    ...
                                                    <div class="col-12 cell<?= $lokasi->id_konten_lokasi ?> collapse contentall<?= $lokasi->id_konten_lokasi ?> border rounded shadow-sm p-3">
                                                        ...
                                                        <div class="row  mb-3">
                                                            ...
                                                            <div class="col isi">
                                                                <img src="<?= $lokasi->foto_konten_lokasi ?>?<?php if ($status = 'nochange') {
                                                                                                                    echo time();
                                                                                                                } ?>" width="100px">
                                                            </div>
                                                        </div>
