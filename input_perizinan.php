...
if (isset($_POST['submit'])) {
  if ($_POST['submit'] == 'Simpan') {
    ...
    $stmt->execute([
      'id_lokasi' => $id_lokasi, 'judul_perizinan' => $judul_perizinan,
    ...
    foreach ($_FILES['doc_uploads']['name'] as $document) {
      ...
      if ($_FILES["doc_uploads"]["size"] == 0) {
        ...
        $file_dokumen_perizinan = $target_dir . 'IZIN_' . $target_file;
        ...
        <div class="container-fluid">
          <form action="" enctype="multipart/form-data" method="POST">
            ...
            <div class='form-group' id='doc-uploads'>
              ...
              <p class="small"> Hanya Menerima Bentuk File .doc, .docx, .pdf, .xls, .xlsx, .ppt, .pptx, .csv, .zip, .rar</p>
