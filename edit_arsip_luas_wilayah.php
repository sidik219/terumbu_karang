        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <a class="btn btn-outline-primary" href="kelola_arsip_laporan_sebaran.php">
                        < Kembali</a><br><br>
            ...
            <section class="content">
                <div class="container-fluid">
                    <form action="" enctype="multipart/form-data" method="POST" name="updateWilayah">
                        ...
                        <table class="table table-striped table-bordered DataWilayah">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center" colspan="4" scope="col">Tahun: <input required type="number" value="<?= $rowlaporan[0]->tahun_arsip_wilayah ?>" name="periode_laporan"></th>
                                <tr>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        ?>
                                            ...
                                            <td class="text-center border"><input required type="number" value="<?= $luastahunan->kurang ?>" name="kurang[]"></td>
                                            <td class="text-center border"><input required type="number" value="<?= $luastahunan->cukup ?>" name="cukup[]"></td>
                                            <td class="text-center border"><input required type="number" value="<?= $luastahunan->baik ?>" name="baik[]"></td>
                                            <td class="text-center border"><input required type="number" value="<?= $luastahunan->sangat_baik ?>" name="sangat_baik[]"></td>
                        ...
                        <input type="text" required value="<?= $laporansebaran->tipe_laporan ?>" name="tipe_laporan" class="form-control mb-4">
                        <p align="center">
