                                ...
                                <tr>
                                    <td colspan="6">
                                        ...
                                        <div class="row  m-0">
                                            ...
                                            <div class="col-12 cell detailcollapser<?= $rowitem->id_reservasi ?>" data-toggle="collapse" data-target=".cell<?= $rowitem->id_reservasi ?>, .contentall<?= $rowitem->id_reservasi ?>">
                                                <p class="fielddetail<?= $rowitem->id_reservasi ?> btn btn-act">
