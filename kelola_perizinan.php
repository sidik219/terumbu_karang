                  ...
                  <td colspan="7">
                    ...
                    <div class="row  m-0">
                      ...
                      <div class="col-12 cell<?= $perizinan->id_perizinan ?> collapse contentall<?= $perizinan->id_perizinan ?> border rounded shadow-sm p-3 bg-light">
                        ...
                        <?php
                        if ($perizinan->alasan_perizinan) {
                          echo
                          "
                        <div class='row mb-2 border p-2 bg-white rounded shadow-sm alasan-perizinan'>
                          <div class='col-md-3 kolom font-weight-bold'>
                            Alasan Perizinan {$perizinan->nama_status_perizinan}
                          </div>
                          <div class='col isi'>
                            {$perizinan->alasan_perizinan}
                          </div>
                        </div>";
                        }
