                                ...
                                <?php foreach ($rowpengadaan as $pengadaan) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a onclick="return konfirmasiHapusPengadaan(event)" href="hapus.php?type=pengadaan_fasilitas&id_pengadaan=<?= $pengadaan->id_pengadaan ?>" class="far fa-trash-alt btn btn-act"></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
