            ...
            <tbody>
              ...
              ?>
                <tr>
                  ...
                  <td><?= $batch->id_titik ?> <?= $batch->keterangan_titik ?><br><a target="_blank" href="http://maps.google.com/maps/search/?api=1&query=<?= $batch->latitude ?>,<?= $batch->longitude ?>&zoom=8" class="btn btn-act"><i class="nav-icon fas fa-map-marked-alt"></i> Lihat di Peta</a></td>
                ...
                <tr>
                  <td colspan="6">
                    <!--collapse start -->
                    <div class="row  m-0">
                      <div class="col-12 cell detailcollapser<?= $batch->id_batch ?>" data-toggle="collapse" data-target=".cell<?= $batch->id_batch ?>, .contentall<?= $batch->id_batch ?>">
                        <p class="fielddetail<?= $batch->id_batch ?>  btn btn-act">
