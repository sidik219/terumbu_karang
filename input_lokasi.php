...
if (isset($_POST['submit'])) {
  ...
  if (mysqli_fetch_assoc($result)) {
    ...
    // Cek data existing
    $result = mysqli_query($conn, "SELECT nama_lokasi FROM t_lokasi WHERE nama_lokasi = '$nama_lokasi'");
    if (mysqli_fetch_assoc($result)) {
      header('location: input_lokasi.php?pesan=lokasi_sudah_terdaftar');
    } else {
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <?php
          if (!empty($_GET['pesan'])) {
            if ($_GET['pesan'] == 'lokasi_sudah_terdaftar') {
              echo '<div class="alert alert-danger" role="alert">
                          Lokasi sudah terdaftar sebelumnya, harap input data yang baru.
                      </div>';
            }
          }
          ?>
        ...
        if (!empty($_GET['pesan'])) {
          if ($_GET['pesan'] == 'Lokasi_Sudah_Ada') {
            echo '<div class="alert alert-warning" role="alert">
                          Kode Lokasi Sudah terpakai oleh lokasi lain.
                      </div>';
          }
        }
        ?>
