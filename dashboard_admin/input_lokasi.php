            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                   <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item ">
                            <a href="tabel_donasi.php" class="nav-link ">
                                <i class="nav-icon fas fa-hand-holding-usd"></i>
                                <p> Kelola Donasi </p>
                            </a>
                        </li>
                        <li class="nav-item ">
                            <a href="tabel_wilayah.php" class="nav-link ">
                                <i class="nav-icon fas fa-globe-asia"></i>
                                <p> Kelola Wilayah </p>
                            </a>
                        </li>
                        <li class="nav-item menu-open">
                            <a href="tabel_lokasi.php" class="nav-link active">
                                <i class="nav-icon fas fa-map-marker" aria-hidden="true"></i>
                                <p> Kelola Lokasi </p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="tabel_titik.php" class="nav-link">
                                 <i class="nav-icon fas fa-crosshairs"></i>
                                 <p> Kelola Titik </p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="tabel_batch.php" class="nav-link">
                                  <i class="nav-icon fas fa-boxes"></i>
                                  <p> Kelola Batch </p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="tabel_tk.php" class="nav-link">
                                  <i class="nav-icon fas fa-disease"></i>
                                  <p> Kelola Terumbu Karang </p>
                            </a>
                        </li>
                        <li class="nav-item">
                             <a href="tabel_jenis_tk.php" class="nav-link">
                                   <i class="nav-icon fas fa-certificate"></i>
                                   <p> Kelola Jenis Terumbu </p>
                             </a>
                        </li>
                        <li class="nav-item">
                             <a href="tabel_perizinan.php" class="nav-link">
                                    <i class="nav-icon fas fa-scroll"></i>
                                    <p> Kelola Perizinan </p>
                             </a>
                        </li>
                        <li class="nav-item">
                            <a href="tabel_laporan.php" class="nav-link">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                    <div class="container-fluid">
                        <a href="tabel_lokasi.php">< Kembali</a><br><br>
            ...
            <section class="content">
                <div class="container-fluid">
                    <form>
                          ...
                          <div class="form-group">
                          <label for="exampleInputEmail1">ID Wilayah</label>
                          <select class="form-control">
                                <option>41051 - Karawang</option>
                                <option>45211 - Indramayu</option>
                                <option>46396 - Pangandaran</option>
                          </select>
                        </div>
                          <div class="form-group">
                                <label for="exampleInputPassword1">Nama Lokasi</label>
                                <input type="#" class="form-control" id="#" placeholder="Nama Daerah/Pantai">
                          </div>
                          <div class="form-group">
