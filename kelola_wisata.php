                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a onclick="return konfirmasiHapusPaket(event)" href="hapus.php?type=paket_wisata&id_paket_wisata=<?= $rowitem->id_paket_wisata ?>" class="far fa-trash-alt btn btn-act"></a>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td colspan="5">
                                            ...
                                            <div class="row  m-0">
                                                <table>
                                                    <div class="col-12 cell detailcollapser<?= $rowitem->id_paket_wisata ?>" data-toggle="collapse" data-target=".cell<?= $rowitem->id_paket_wisata ?>, .contentall<?= $rowitem->id_paket_wisata ?>">
                                                    ...
                                                    <div class="col-12 cell<?= $rowitem->id_paket_wisata ?> collapse contentall<?= $rowitem->id_paket_wisata ?> border rounded shadow-sm p-3">
                                                        ...
                                                        <div class="row  mb-3">
                                                            ...
                                                            <div class="col isi">
                                                                <img src="<?= $rowitem->foto_wisata ?>?<?php if ($status = 'nochange') {
                                                                                                            echo time();
                                                                                                        } ?>" width="100px">
                                                            </div>
                                                        </div>
