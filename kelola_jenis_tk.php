                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a onclick="return konfirmasiHapusTerumbu(event)" href="hapus.php?type=jenis&id_jenis=<?= $rowitem->id_jenis ?>" class="far fa-trash-alt btn btn-act"></a>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td colspan="3">
                                        <!--collapse start -->
                                        <div class="row  m-0">
                                            <div class="col-12 cell detailcollapser<?= $rowitem->id_jenis ?>" data-toggle="collapse" data-target=".cell<?= $rowitem->id_jenis ?>, .contentall<?= $rowitem->id_jenis ?>">
                                                <p class="fielddetail<?= $rowitem->id_jenis ?>  btn btn-act">
                                            ...
                                            <div class="col-12 cell<?= $rowitem->id_jenis ?> collapse contentall<?= $rowitem->id_jenis ?> border rounded shadow-sm p-3">
                                                ...
                                                <div class="row  mb-3">
                                                    ...
                                                    <div class="col isi">
                                                        <img src="<?= $rowitem->foto_jenis ?>?<?php if ($status = 'nochange') {
                                                                                                    echo time();
                                                                                                } ?>" width="150px">
                                                    </div>
                                                </div>
