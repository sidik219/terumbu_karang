                ...
                <label class="text-muted text-sm d-block">Tentukan biaya operasional yang dibutuhkan untuk pemeliharaan terumbu karang</label>
                    ...
                    <tbody id="tbody-append">
                        <?php foreach ($rowdetail as $rowitem) { ?>
                            ...
                            <td class="">
                                <a href="#" onclick='loadPatokanTerumbu(this.dataset.id_biaya_operasional)'
                                data-nama_biaya_operasional='<?=$rowitem->nama_biaya_operasional?>' data-id_biaya_operasional='<?=$rowitem->id_biaya_operasional?>'
                                  class="fas fa-edit mr-3 btn btn-act"></a>
                                <a href="hapus.php?type=biaya_operasional&id_biaya_operasional=<?=$rowitem->id_biaya_operasional?>&id_lokasi=<?=$id_lokasi?>" class="far fa-trash-alt btn btn-act"></a>
                                </td>
                            </tr>
                           <?php } ?>
                    </tbody>
    ...
    <div class="modal-header">
      ...
      <div class="col border rounded p-2 bg-light">
                            <div class="row mb-1">
                              ...
                              <input type="text" class="form-control" name="nama_biaya_operasional" required/>
                            </div>
                            </div>
