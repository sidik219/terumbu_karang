  ...
  header('location: login.php?status=restrictedaccess');
    ...
    if (isset($_POST['submit'])) {
        ...
        $sqldonasi = "UPDATE t_donasi
                        SET id_status_pengadaan_bibit = :id_status_pengadaan_bibit, update_terakhir = :update_terakhir, bukti_pengadaan_bibit = :bukti_pengadaan_bibit
                        WHERE id_donasi = :id_donasi";

        $stmt = $pdo->prepare($sqldonasi);
        $stmt->execute(['id_donasi' => $id_donasi, 'id_status_pengadaan_bibit' => 3, 'update_terakhir' => $tanggal_update_status, 'bukti_pengadaan_bibit' => $bukti_pengadaan_bibit]);
